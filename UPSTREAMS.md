...
- Adaptation: added `rmode` and `argus-mode` entry points over the shared workflow, removed Cursor-only packaging, replaced host-specific tools and hard-coded models with capability-based behavior, and preserved portable scripts.
