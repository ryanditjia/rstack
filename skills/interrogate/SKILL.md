...
If a configured model is unavailable, inherit the current model and note the fallback. Treat `inherit-parent` and `auto` as explicit requests to omit model selection. Do not open a PR or edit configuration unless the user asked.
