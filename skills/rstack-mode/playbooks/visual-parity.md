...
4. Verify each component against its baseline via image diff on the matching surface. A nonzero diff is a fail; investigate the pixel delta. Use the host's persistent-work mechanism per component until the diff is zero.
