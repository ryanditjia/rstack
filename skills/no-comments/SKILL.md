---
name: no-comments
description: "Spawn a reviewer subagent, fix accepted findings, and offer encodings for claimed constraints."
disable-model-invocation: true
---

# No comments

Spawn a reviewer subagent. Act on accepted findings.
...
1. Spawn `Task` with a reviewer subagent. Pass the scope. Do not restate its rules.
