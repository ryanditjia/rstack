...
**PRs.** Run a diff-cleanup pass from available host tooling over the diff before commit. Run the no-comments skill before review. Keep PR titles, descriptions, and commit bodies concise and concrete.
